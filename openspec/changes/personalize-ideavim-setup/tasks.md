...
- [x] 3.4 Verify `<C-h/j/k/l>` split navigation with `sethandler` — resolved globally: `sethandler n-v:vim i:ide` (Vim wins normal/visual conflicts, IDE keeps insert), covering split-nav and resize-arrow keys
